...
import projectImage from '@/assets/img/projects/srchevents.png'
...
export default function Home() {
  ...
  const features = [
    'Supabase auth - create user accounts, login, logout',
    'Upload Events - select and upload images to Supabase storage, rich text editor',
    'Responsive grid'
  ]
    ...
    <div>
      ...
      <main className="main_container items-center">
        <div className="w-full max-w-xl">
          <PageTitle
            title="Srch Events"
            address="https://www.srchevents.co.za"
          />
          <div className="w-full aspect-[4/3] p-3 box_radius bg-neutral-100 overflow-hidden">
            <Image
              draggable={false}
              className="object-contain bg-neutral-200 rounded-md shadow-xl object-top w-full h-fullf left-0"
              src={projectImage}
              alt="project image"
            />
          </div>
          ...
          <p className="block mt-5 w-full max-w-2xl flex-grow leading-relaxed text-lgF">
            ...
            and MUI. Data and images are stored on Supabase.
          </p>
          <SectionDivider />
