  ...
  return (
    <div>
      {/* <div className="w-full flex justify-center mt-6 space-x-4">
        <div className="w-40f px-5 pt-2 text-sm flat_shadow select-none cursor-pointer pb-2.5 h-10f border border-neutral-500 text-center">
          Portfolio
        </div>
        <div className="w-40f px-5 pt-2 text-sm flat_shadow select-none cursor-pointer pb-2.5 h-10f border border-neutral-500 text-center">
          Extras
      ...
      <main className="page_width_wide bg-white bg-opacity-75 border flat_shadow mt-8 mb-20 border-neutral-500 main_shadowF pt-10 pb-4 mx-auto flex w-full flex-col">
        {/* <div className="h-20 border-b border-neutral-500"></div> */}
        <div className="w-full text-sm flex xs:flex-col md:flex-row xs:space-x-0 xs:space-y-10 md:space-y-0 md:space-x-10">
          <div className="inline-block flat_shadowf xs:m-auto md:m-0 w-48 border border-neutral-500 flex-shrink-0 h-48 flex-grow-0 bg-gray-100 rounded-fullf overflow-hidden">
            <Image
              draggable="false"
        ...
        <p className="block mt-10 mb-2 w-full max-w-2xl flex-grow leading-relaxed text-lgF">
        ...
        <div className="relative mt-5 mb-10 flex w-full flex-wrap space-y-12">
          {projectsList &&
