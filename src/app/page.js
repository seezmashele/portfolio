...
export default function Home() {
  return (
    <main className="page_width_wide bg-white bg-opacity-75 border flat_shadow m-10 mb-20 border-neutral-500 main_shadowF pt-10 pb-4 mx-auto flex w-full flex-col">
